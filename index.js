...
if (evento1.chatComIdolo) {
    ...
    console.log(`Francisco El Hombre não aceitou fazer o Chat com o Ídolo!`)
}
...
if (evento2.chatComIdolo) {
   ...
   console.log(`Guitaura Medieval não aceitou fazer o Chat com o Ídolo!`)
}
...
if (evento3.chatComIdolo) {
    ...
    console.log(`Plutão Já Foi Planeta não aceitou fazer o Chat com o Ídolo!`)
}
...
if (evento4.chatComIdolo) {
    ...
    console.log(`Emicida não aceitou fazer o Chat com o Ídolo!`)
}
